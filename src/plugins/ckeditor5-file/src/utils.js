 ...
 * @returns {Boolean}
 */
export function isFileAllowed (model) {
  const schema = model.schema
  const selection = model.document.selection
  // console.log('--', isFileAllowedInParent(selection, schema, model))
  // console.log(!checkSelectionOnObject(selection, schema))
  // console.log(isInOtherFile(selection), '==')
  const res = isFileAllowedInParent(selection, schema, model) && !checkSelectionOnObject(selection, schema) && isInOtherFile(selection)
  return res
}
...
//
// @returns {Boolean}
function isFileAllowedInParent (selection, schema, model) {
  return true
  // const parent = getInsertFileParent(selection, model)
  // console.log(parent)
  // return schema.checkChild(parent, 'file')
}
...
function isInOtherFile (selection) {
  return [...selection.focus.getAncestors()].every(ancestor => !ancestor.is('file'))
}
